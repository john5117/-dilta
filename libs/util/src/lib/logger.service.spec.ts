...
describe('Service: Logger', () => {
  ...
  it(
    'log:::should call jsLogger log function',
  ...
  it(
    'warn:::should call jsLogger warn function',
    inject([LoggerService], (service: LoggerService) => {
  ...
  it(
    'debug:::should call jsLogger debug function',
    inject([LoggerService], (service: LoggerService) => {
  ...
  it(
    'error:::should call jsLogger error function',
    inject([LoggerService], (service: LoggerService) => {
  ...
  it(
    'info:::should call jsLogger info function',
    inject([LoggerService], (service: LoggerService) => {
  ...
  it(
    'validate:::should throw error for invalid log object',
    inject([LoggerService], (service: LoggerService) => {
      const values = [
        undefined,
